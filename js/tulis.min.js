...
var setData = dataConfig + "/" + orderID;
...
$(document).ready(function(){
	...
	dbRef.child(dataConfig).on("value", persiapan => {
		$("#data").html("");
		persiapan.forEach(baca =>{
			...
			//kode eksekusi
			console.log(nilai.a);
			var tableN = "<tr><td data-id="+kunci+">"+nilai.a+"</td><td>"+nilai.b+"</td><td>"+nilai.c+"</td></tr>";
